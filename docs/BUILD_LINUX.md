...
```
$ sudo apt install build-essential git autoconf cmake libfreetype6-dev libsdl2-dev libasound2-dev libharfbuzz-dev libbz2-dev libglew-dev libsamplerate0-dev
```
...
If you don't want to install RmlUi as a system library, use the following option:
...
$ cd glew-2.2.0/build 
$ cmake cmake -G "Unix Makefiles" -DBUILD_SHARED_LIBS=OFF -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX:PATH=/home/marco/workspace/glew-2.2.0/release
$ make -j`nproc`
$ make install
```
...
```
$ cd RmlUi/build/  
$ cmake .. -G "Unix Makefiles" -DBUILD_SHARED_LIBS=OFF -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX:PATH=/home/marco/workspace/RmlUi/release
$ make -j`nproc`
$ make install
```

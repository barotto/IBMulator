...
public:
	...
	/*
	 * Modified to operate on two stereo interleaved buffers, mixing the result on out_mix buffer
	 */
	void process(int sampleFrames, T *in_data, T *out_mix)
	{

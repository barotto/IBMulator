...
/* 04 ADD AL,db      3           2          */ cBase(3),         cBase(2),
/* 05 ADD AX,dw      3           2          */ cBase(3),         cBase(2),
...
/* 0C OR AL,db       3           2          */ cBase(3),          cBase(2),
/* 0D OR AX,dw       3           2          */ cBase(3),          cBase(2),
...
/* 14 ADC AL,db      3           2          */ cBase(3),          cBase(2),
/* 15 ADC AX,dw      3           2          */ cBase(3),          cBase(2),
...
/* 1C SBB AL,db      3           2          */ cBase(3),          cBase(2),
/* 1D SBB AX,dw      3           2          */ cBase(3),          cBase(2),
...
/* 24 AND AL,db      3           2          */ cBase(3),          cBase(2),
/* 25 AND AX,dw      3           2          */ cBase(3),          cBase(2),
...
/* 2C SUB AL,db      3           2          */ cBase(3),          cBase(2),
/* 2D SUB AX,dw      3           2          */ cBase(3),          cBase(2),
...
/* 34 XOR AL,db      3           2          */ cBase(3),          cBase(2),
/* 35 XOR AX,dw      3           2          */ cBase(3),          cBase(2),
...
/* 3C CMP AL,db      3           2          */ cBase(3),          cBase(2),
/* 3D CMP AX,dw      3           2          */ cBase(3),          cBase(2),
...
/* A8 TEST AL,db     3           2          */ cBase(3),          cBase(2),
/* A9 TEST AX,dw     3           2          */ cBase(3),          cBase(2),
...
/* B0 MOV AL,db      2           2          */ cBase(2),          cBase(2),
/* B1 MOV CL,db      2           2          */ cBase(2),          cBase(2),
/* B2 MOV DL,db      2           2          */ cBase(2),          cBase(2),
/* B3 MOV BL,db      2           2          */ cBase(2),          cBase(2),
/* B4 MOV AH,db      2           2          */ cBase(2),          cBase(2),
/* B5 MOV CH,db      2           2          */ cBase(2),          cBase(2),
/* B6 MOV DH,db      2           2          */ cBase(2),          cBase(2),
/* B7 MOV BH,db      2           2          */ cBase(2),          cBase(2),
/* B8 MOV AX,dw      2           2          */ cBase(2),          cBase(2),
/* B9 MOV CX,dw      2           2          */ cBase(2),          cBase(2),
/* BA MOV DX,dw      2           2          */ cBase(2),          cBase(2),
/* BB MOV BX,dw      2           2          */ cBase(2),          cBase(2),
/* BC MOV SP,dw      2           2          */ cBase(2),          cBase(2),
/* BD MOV BP,dw      2           2          */ cBase(2),          cBase(2),
/* BE MOV SI,dw      2           2          */ cBase(2),          cBase(2),
/* BF MOV DI,dw      2           2          */ cBase(2),          cBase(2),
/* C0 Group 2                               */ cNull,             cNull,
/* C1 Group 2                               */ cNull,             cNull,
/* C2 RET dw         11          10         */ cBase(7),          cBase(6),
...
/* C6 MOV eb,db      2/3         2/2        */ cBaseMem(2,3),     cBaseMem(2,2),
/* C7 MOV ew,dw      2/3         2/2        */ cBaseMem(2,3),     cBaseMem(2,2),
/* C8 ENTER dw,db    11          10         */ cBase(12),         cBase(11),
/* C9 LEAVE          5           4          */ cBase(3),          cBase(2),
/* CA RET dw         15,p25      18,pm32    */ cBasePM(11,7),     cBasePM(14,12),
/* CB RET            15,p25      18,pm32    */ cBasePM(11,7),     cBasePM(14,12),
/* CC INT 3          23,p40      33,pm59    */ cBasePM(13,7),     cBasePM(23,10),
/* CD INT db         23,p40      37,pm59    */ cBasePM(13,7),     cBasePM(23,10),
...
/* E4 IN AL,db       5           12,p26     */ cBase(3),          cBasePM(10,14),
/* E5 IN AX,db       5           12,p26     */ cBase(3),          cBasePM(10,14),
/* E6 OUT db,AL      3           10,p24     */ cBase(3),          cBasePM(10,14),
/* E7 OUT db,AX      3           10,p24     */ cBase(3),          cBasePM(10,14),
...
/* 80 /0 ADD eb,db  3/7  2/7  */ cBaseMem(3,5), cBaseMem(2,5),
/* 80 /1 OR  eb,db  3/7  2/7  */ cBaseMem(3,5), cBaseMem(2,5),
/* 80 /2 ADC eb,db  3/7  2/7  */ cBaseMem(3,5), cBaseMem(2,5),
/* 80 /3 SBB eb,db  3/7  2/7  */ cBaseMem(3,5), cBaseMem(2,5),
/* 80 /4 AND eb,db  3/7  2/7  */ cBaseMem(3,5), cBaseMem(2,5),
/* 80 /5 SUB eb,db  3/7  2/7  */ cBaseMem(3,5), cBaseMem(2,5),
/* 80 /6 XOR eb,db  3/7  2/7  */ cBaseMem(3,5), cBaseMem(2,5),
/* 80 /7 CMP eb,db  3/6  2/5  */ cBaseMem(3,4), cBaseMem(2,3)
};
static const Cycles cycles_81[8*2] = {
/* 81 /0 ADD ew,dw  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 81 /1 OR  ew,dw  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 81 /2 ADC ew,dw  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 81 /3 SBB ew,dw  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 81 /4 AND ew,dw  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 81 /5 SUB ew,dw  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 81 /6 XOR ew,dw  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 81 /7 CMP ew,dw  3/6  2/5  */ cBaseMem(3,4), cBaseMem(2,3)
};
static const Cycles cycles_83[8*2] = {
/* 83 /0 ADD ew,db  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 83 /1 OR  ew,db  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 83 /2 ADC ew,db  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 83 /3 SBB ew,db  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 83 /4 AND ew,db  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 83 /5 SUB ew,db  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 83 /6 XOR ew,db  3/7  2/7  */ cBaseMem(3,8), cBaseMem(2,8),
/* 83 /7 CMP ew,db  3/6  2/5  */ cBaseMem(3,4), cBaseMem(2,3),
};

// Group 2
static const Cycles cycles_C0[8*2] = {
/* C0 /0 ROL eb,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5),
/* C0 /1 ROR eb,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5),
/* C0 /2 RCL eb,db  5/8  9/10 */ cBaseMem(5,6), cBaseMem(9,8),
/* C0 /3 RCR eb,db  5/8  9/10 */ cBaseMem(5,6), cBaseMem(9,8),
/* C0 /4 SHL eb,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5),
/* C0 /5 SHR eb,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5),
/* C0 /6 SAL eb,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5),
/* C0 /7 SAR eb,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5)
};
static const Cycles cycles_C1[8*2] = {
/* C1 /0 ROL ew,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5),
/* C1 /1 ROR ew,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5),
/* C1 /2 RCL ew,db  5/8  9/10 */ cBaseMem(5,6), cBaseMem(9,8),
/* C1 /3 RCR ew,db  5/8  9/10 */ cBaseMem(5,6), cBaseMem(9,8),
/* C1 /4 SHL ew,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5),
/* C1 /5 SHR ew,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5),
/* C1 /6 SAL ew,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5),
/* C1 /7 SAR ew,db  5/8  3/7  */ cBaseMem(5,6), cBaseMem(3,5)
};
...
/* F6 /0 TEST eb,db  3/6    2/5    */ cBaseMem(3,4),   cBaseMem(2,3),
...
/* F7 /0 TEST ew,dw  3/6    2/5    */ cBaseMem(3,4),   cBaseMem(2,3),

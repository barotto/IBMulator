...
private:
	...
	std::function<void(std::string, std::string, FloppyDiskType, bool)> m_create_clbk = nullptr;
...
public:
	...
	void set_callbacks(
		std::function<void(std::string, std::string, FloppyDiskType, bool)> _create_callback,
